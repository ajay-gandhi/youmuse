import { ACTION_TYPES, INITIAL_STATE, REPEAT_STATE, MAX_QUEUE_SIZE } from "./constants";
...
const generateQueue = (playlist, shuffle, repeat) => {
...
const refillQueue = (queue, playlist, shuffle, repeat) => {
...
const removeFromQueueById = (queue, id) => copyArray(queue).filter(o => o.id !== id);
const removeFromQueueByIndex = (queue, index) => copyArray(queue).filter((o, i) => i !== index);
